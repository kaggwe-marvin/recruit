...
const Loginpage = ({ navigation }) => {
  ...
  return (
    ...
    resizeMode="contain"
      />
      <Text style={styles.title}>Hello! Applicant.</Text>

      <Image
    style={styles.heroImage2}
    source={{uri: 'https://panafricanvisions.com/wp-content/uploads/2014/09/706x410q70simamkele-and-friend-unemployment-subbedm.jpg'}}
    resizeMode="contain"
      />
